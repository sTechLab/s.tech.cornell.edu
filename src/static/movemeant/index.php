...
<html>
<head>
<title>Movemeant App- from the Social Tech Lab at Cornell Tech</title>
...
<meta name="keywords" content="Movemeant, Social Tech Lab, Community Awareness App" />
				...
				<li>
				  ...
				  <div class="caption text-center">
					<div class="slide-text-info">
						<h1>Introducing <span>Movemeant</span></h1>
						...
						<div class="slide-text">
							<ul>
								...
								<li><span> </span>Learn about the places trending with your neighbors</li>
							</ul>
							<br><br></br>
						</div>

						<div class="cta">We're looking for people in select residence buildings and offices to beta test Movemeant! During the 2 week trial, you'll use Movemeant along with your neighbors or coworkers. At the end, we'll send you a survey to get your opinions, and you'll be entered to win a new iPad! Contact us at s.tech.cornell@gmail.com if you have any questions about participating in the study.</div>
						<div class="big-btns">
							<a href="//cornell.qualtrics.com/jfe/form/SV_cT5vZ50ATYHNcEJ" target="blank">Sign-Up to Test</a>
				
						</div>
				<img class="divice-demo" src="images/device-in-hand.png" title="Movemeant in hand" />
					</div>
					</div>
				</li>
			  </ul>
...
physical support. Movemeant is an app that uses location data generated automatically by mobile devices to

increase community awareness following a new standard

of privacy preservation.  
						<p>Movemeant was designed and developed by the <a href="http://s.tech.nyc" target="blank">Social Technologies Lab</a> at <a href="tech.cornell.edu" target="blank">Cornell Tech</a>. <br>This work was funded by AOL through the <a href="http://www.connectedexperiences.org" target="blank">Connected Experiences Laboratory.</a></p>
					</div>
				</div>
				<!----team-members---->
		...
		<div id="contact" class="getintouch">
			<div class="container">
				<div class="section-head text-center">
					...
					<p>This is the first field deployment of Movemeant, so please let us know what you think so that we can incorporate your feedback into future iterations. Thank you for testing it out!</p>
				</div>
				<!---->
			...
			<div class="container">
				<div class="footer-grids">
					<div class="col-md-3 footer-grid about-info">
						<a href="#"><img src="images/logo.png" title="Movemeant" /></a>
